...
class MilkCategory(models.Model):
    ...
    milkprice = models.FloatField(db_index=True)  # REMOVED max_length
...
class vendorledger(models.Model):
    ...
    date = models.CharField(max_length=100, db_index=True)  # CHANGED: from 1000000 to 100
    price = models.FloatField(db_index=True, default=0.0)  # REMOVED max_length
    quantity = models.FloatField(db_index=True, default=0.0)  # REMOVED max_length
    total = models.FloatField(db_index=True, default=0.0)  # REMOVED max_length
