    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('milkprice', models.FloatField(db_index=True)),
            ],
        ),
        migrations.CreateModel(
            name='Vendor',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.CharField(db_index=True, max_length=100)),
                ('price', models.FloatField(db_index=True, default=0.0)),
                ('quantity', models.FloatField(db_index=True, default=0.0)),
